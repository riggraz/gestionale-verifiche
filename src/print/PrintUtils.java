...
import print.PagePosition;
import print.PageProperty;
...
public class PrintUtils {
	...
	/*	posPag.getContentStream().newLineAtOffset(0, -leading);
      	posPag.setRiga(posPag.getRiga() +1);*/
	   ...
	   public static void printWithDialogAndAttributes(PDDocument document)
	    {
	        ...
	        attr.add(new Copies(1));  //Imposta numero copie
